...
vec4 transition(vec2 uv) {
  ...
  vec4 b=getToColor(p);
  return mix(a, b, step(1.0-p.y,u_time));
}
...
const WipeUp = ({ width, height, startVideoSrc, endVideoSrc }: WipeUpProps) => {
